...
router.post('/auth/google', async (req, res) => {
  try {
    ...
    const isAudienceError = /Wrong recipient|audience|client/i.test(error.message || '');
    const message = isAudienceError
      ? 'Client ID Google frontend dan backend tidak sama. Samakan VITE_GOOGLE_CLIENT_ID dan GOOGLE_CLIENT_ID, lalu redeploy.'
